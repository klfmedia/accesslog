<!-- Navigation -->
        <nav class=" navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
              <a href="main">  <img width="30%" src="public/upload/images/company/klf-Logo.png" alt="Logo KLF" /> </a>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="admin/user/edit/{{ Auth::user()->id }}"><i class="fa fa-user fa-fw" style="color:green;"></i> Profile</a>
                        </li>
                        <li class="divider"></li>
