            ...
            <div class="container-fluid" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xs-12" style="padding-bottom:80px">
                        ...
                        <form action="admin/html/notice/{{$notice->id}}" method="POST" >
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <input type="hidden" name="_method" value="PUT">


                        <div style="padding-bottom: 18px;">Notify Date <br/>
                        <input type="date" id="txtNotifyDate" name="txtNotifyDate" style="width : 450px;" class="form-control" value="{{ $notice->notifyDate }}"/>
                        </div>
                        <div style="padding-bottom: 18px;">Expire Date <br/>
                        <input type="date" id="txtExpireDate" name="txtExpireDate" style="width : 450px;" class="form-control" value="{{ $notice->expireDate }}"/>
                        </div>
                        <div style="padding-bottom: 18px;">Description<br/>
                        <textarea style="width : 450px; height: 100px" class="form-control" name="txtDescription" >{{ $notice->description }} </textarea>
                        </div>
                        <div style="padding-bottom: 18px;">Emergency<br/>
                        <span><input type="radio"  name="ckbLevel" value="1"  {{ $notice->level==1 ? " checked ":"" }}/>Normal</span><br/>
                        <span><input type="radio"  name="ckbLevel" value="2" {{ $notice->level==2 ? " checked ":"" }}/>Emergency</span><br/>
                        </div>
